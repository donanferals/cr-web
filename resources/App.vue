<template>
  <div class="bg-white">
            ...
            <div class="ml-auto flex items-center">
              ...
              <div class="ml-4 flow-root lg:ml-6">
                <a href="#" class="group -m-2 flex items-center p-2">
                  <ShoppingBagIcon class="h-6 w-6 flex-shrink-0 text-gray-400 group-hover:text-gray-500" aria-hidden="true" @click="apresentarCarrinho()"/>
    ...
    <!-- Carrinho -->
    <div class="relative z-10" aria-labelledby="slide-over-title" role="dialog" aria-modal="true" v-if="abrirCarrinho">
              ...
              <div class="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                <div class="flex items-start justify-between">
                  ...
                  <div class="ml-3 flex h-7 items-center">
                    <button type="button" class="-m-2 p-2 text-gray-400 hover:text-gray-500" @click="apresentarCarrinho()">
...
const getFoto = (produto) => {
  console.log(produto);
  return produto.value.img_cover;
}
